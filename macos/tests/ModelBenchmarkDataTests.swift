...
struct ModelBenchmarkDataTests {
    static func main() throws {
        ...
        precondition(manual.supportsThinking == nil)
        precondition(manual.supportsFunctionTools == nil)
        precondition(manual.supportsImage == nil)
        precondition(manual.supportsWebSearch == nil)
        precondition(manual.supportsToolSearch == nil)
