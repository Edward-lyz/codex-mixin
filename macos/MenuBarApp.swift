...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private var fusionSettingsWindowController: FusionSettingsWindowController?
    ...
    @objc private func showFusionSettings() {
    ...
    private func fetchFusionModelOptions() async throws -> [FusionModelOption] {
        guard
...
private func releaseNotesSection(_ body: String, key: String) -> String? {
...
private func readableReleaseNotes(_ markdown: String) -> String {
...
private func releaseNotesView(title: String, notes: String) -> NSView {
