...
| Mac 架构 | 下载文件 |
| --- | --- |
| Apple Silicon | `codex-mixin-0.2.6-aarch64-apple-darwin.dmg` |
| Intel | `codex-mixin-0.2.6-x86_64-apple-darwin.dmg` |
...
```bash
xattr -dr com.apple.quarantine codex-mixin-0.2.6-aarch64-apple-darwin.dmg
...
- macOS Apple Silicon: `codex-mixin-cli-0.2.6-aarch64-apple-darwin.tar.gz`
- macOS Intel: `codex-mixin-cli-0.2.6-x86_64-apple-darwin.tar.gz`
- Linux x86_64: `codex-mixin-cli-0.2.6-x86_64-unknown-linux-gnu.tar.gz` 或 `codex-mixin-0.2.6-x86_64-unknown-linux-gnu.deb`
- Linux ARM64: `codex-mixin-cli-0.2.6-aarch64-unknown-linux-gnu.tar.gz` 或 `codex-mixin-0.2.6-aarch64-unknown-linux-gnu.deb`
...
- macOS Apple Silicon: `codex-mixin-cli-0.2.6-aarch64-apple-darwin.tar.gz`
- macOS Intel: `codex-mixin-cli-0.2.6-x86_64-apple-darwin.tar.gz`
- Linux x86_64: `codex-mixin-cli-0.2.6-x86_64-unknown-linux-gnu.tar.gz` or `codex-mixin-0.2.6-x86_64-unknown-linux-gnu.deb`
- Linux ARM64: `codex-mixin-cli-0.2.6-aarch64-unknown-linux-gnu.tar.gz` or `codex-mixin-0.2.6-aarch64-unknown-linux-gnu.deb`
